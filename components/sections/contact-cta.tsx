...
export function ContactCTA() {
  return (
    <section id="contact" className="relative z-10 py-15">
      <div className="relative overflow-hidden rounded-3xl border border-white/12 bg-[#0b0b0d]/88 p-6 shadow-xl shadow-black/30 md:p-10">
        ...
        <div className="pointer-events-none absolute top-[-150px] right-[-150px] h-[320px] w-[320px] rounded-full bg-blue-500/[0.08] blur-[80px]" />
        <div className="pointer-events-none absolute bottom-[-170px] left-[-140px] h-[340px] w-[380px] rounded-full bg-white/[0.04] blur-[90px]" />
        ...
        <div className="relative z-10 grid gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:items-end">
          <div>
            ...
            <div className="mt-8 flex flex-wrap items-center gap-3">
              ...
              <Link
                href="/projects"
                className="group inline-flex h-11 items-center justify-center rounded-lg border border-white/10 bg-transparent px-6 text-sm font-medium text-white transition hover:bg-white hover:text-black"
              >
                View projects
